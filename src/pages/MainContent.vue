<template>
  ...
  >
    ...
    <div class="main-content__map">
      <app-map
        :messageGeojson="
          selectedTheme != undefined ? filteredCurrentLayer : undefined
        "
        :relatedLayers="
          selectedTheme != undefined ? selectedTheme.relatedLayers : undefined
        "
    ...
    <transition name="fade">
      <div class="main-content__themes" v-if="themesIsShown">
        <v-container fluid grid-list-md>
          <theme-list
            class="first-screen__theme-list"
            :themes="themes"
          ></theme-list>
        </v-container>
      </div>
    ...
    >
      {{ snackbar.text }}
      <v-btn dark flat @click="snackbar.visibility = false">Закрыть</v-btn>
    </v-snackbar>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState(['themes', 'selectedThemeId', 'user', 'formActive']),
